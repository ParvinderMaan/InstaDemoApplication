package com.app.instademoapplication.drinks;
...
public class AlcoholFragment extends BaseFragment {
    public static final String TAG = AlcoholFragment.class.getSimpleName();
        ...
        (v.findViewById(R.id.tv_title)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                getChildFragmentManager().beginTransaction()
                        .add(R.id.fl_container,BeerFragment.newInstance())
